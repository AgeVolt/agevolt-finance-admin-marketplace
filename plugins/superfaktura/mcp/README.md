...
Agent ma volat priamo MCP tooly `sf.*`. Priame HTTP volania na `/index.php/sf.*` su iba diagnostika pocas vyvoja servera, nie bezny fallback pre pouzivatelske tasky.
